...
CREATE TABLE PROCEDURES_NY_TOTAL AS SELECT HCPCS_CODE, HCPCS_DESCRIPTION, NPPES_PROVIDER_CITY, COUNT(1) AS COUNT_PROVIDERS FROM medicare_stream_ny GROUP BY HCPCS_CODE, HCPCS_DESCRIPTION, NPPES_PROVIDER_CITY;
CREATE TABLE PROCEDURES_NY_TOTAL_2 AS SELECT HCPCS_CODE, HCPCS_DESCRIPTION, NPPES_PROVIDER_CITY, COUNT(1) AS COUNT_PROVIDERS FROM medicare_stream_ny GROUP BY HCPCS_CODE, HCPCS_DESCRIPTION, NPPES_PROVIDER_CITY EMIT CHANGES;
